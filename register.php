            ...
            <div class="row">
                <div class="col-xs-6">
                    <div class="b-contacts__form">
                        ...
                        <?php if (isset($_SESSION['status_regist'])){ ?>
                        <p class=" wow zoomInUp"> <?php echo $_SESSION['status_regist'] ?> </p>
                        <p class=" wow zoomInUp" data-wow-delay="0.5s">Have an account? Login <a href="login.php"> here</a></p>
                        <div id="failed"></div>
                            <?php } else { ?>
                        <div id="success"></div>
                        <?php } ?>
                        <form action="backend\register_.php" method="POST" id="contactForm" class="s-form wow zoomInUp" data-wow-delay="0.5s">
                            <input type="text" placeholder="FULL NAME" value="" name="user-name" id="user-name" required pattern="[A-Za-z\s]+"/>
                            <input type="text" placeholder="EMAIL ADDRESS" value="" name="user-email" id="user-email" required pattern="[^ @]*@[^ @]*"/>
                            <input type="text" placeholder="PHONE NO." value="" name="user-phone" id="user-phone"  pattern="[0-9]+"/>
                            <input type="password" placeholder="PASSWORD" value="" name="user-password" id="user-password" required minlength="8"/>
