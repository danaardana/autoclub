...
<body class="m-404" data-scrolling-animations="true">
    ...
    <section class="b-pageHeader">
        <div class="container">
            <h1 class="wow zoomInUp" data-wow-delay="0.7s">Unsubscribe</h1>
        </div>
    </section>
    <!--b-pageHeader-->
    ...
    <section class="b-error s-shadow">
        <div class="container">
            <h1 class="wow zoomInUp" data-wow-delay="0.7s">Your now unsubcribe our service</h1>
            <h2 class="s-lineDownCenter wow zoomInUp" data-wow-delay="0.7s">Thank you for using our service</h2>
        </div>
    </section>
    <!--b-unsubscribe-->
