...
<body class="m-404" data-scrolling-animations="true">
    ...
    <section class="b-pageHeader">
        <div class="container">
            <h1 class="wow zoomInUp" data-wow-delay="0.7s">Login</h1>
        </div>
    </section>
    <!--b-pageHeader-->
    ...
    <div class="b-breadCumbs s-shadow">
        <div class="container">
            <a href="home.html" class="b-breadCumbs__page">Home</a><span class="fa fa-angle-right"></span><a href="404.html" class="b-breadCumbs__page m-active">Login</a>
        </div>
    </div>
    <!--b-breadCumbs-->
            ...
            <div class="row">
                <div class="col-xs-6">
                    <div class="b-contacts__form">
                        ...
                        <p class=" wow zoomInUp" data-wow-delay="0.5s">Don't have an account? Register <a href="register.php"> here</a></p>
                        <div id="success"></div>
                        <form id="contactForm" action="backend\login_.php" method="POST" class="s-form wow zoomInUp" data-wow-delay="0.5s">
                            <input type="text" placeholder="EMAIL ADDRESS %" value="" name="login-email" id="login-email" required />
                            <input type="password" placeholder="PASSWORD" value="" name="login-password" id="login-password" required />
                            </span>
                            <button type="submit" class="btn m-btn">Sign In<span class="fa fa-angle-right"></span></button>
                        </form>
                        <?php if (isset($_SESSION['status_login'])){ ?>
                        <p class=" wow zoomInUp" data-wow-delay="0.5s"><?php echo "Email and Password inccorect." ?> </p>
                        <?php } ?>
                    </div>
                </div>
                <div class="col-xs-6">
