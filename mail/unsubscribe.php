                                                ...
                                                <tr>
                                                    <td height="25" valign="middle">
                                                        ...
                                                        <table width="211" align="left" cellspacing="0" cellpadding="0" border="0" class="full-width">
                                                            <tbody>
                                                                <tr>
                                                                    <td height="30" valign="middle" align="left" class="center-stack"  style="font-family: Open Sans, sans-serif;font-size: 18px;font-weight:bold;" ><a href="#"><span style="color: #FF6600;font-size:24px;font-weight:bold;">AUTO</span>CLUB</a></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <!-- End Logo -->
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <table bgcolor="#666666" width="100%" cellspacing="0" cellpadding="0" border="0" background="img/banner2.jpg" style="background-repeat: no-repeat; !important; background-position: center center;background-size: cover;" class="full-width">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td class="front" style="font-family: Open Sans, sans-serif; font-size: 60px;mso-line-height-rule:exactly; line-height:60px; font-weight: bold; color: #ffffff;" align="center"> UNSUBSCRIBE </td>
                                                                </tr>
                                                                <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td valign="top" align="center">
                                                                                ...
                                                                                <table width="357" align="left" cellspacing="0" cellpadding="0" border="0" class="full-width">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td align="left" style="font-size:15px; color:#2c3e50; font-weight:bold; font-family: Open Sans, sans-serif;">Dear Custumer, </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td height="26" align="left"><img src="img/green_line.jpg" width="30" height="2" alt="" /></td>
                                                                                        </tr>
                                                                                        <tr >
                                                                                            <td style="font-size:13px;mso-line-height-rule:exactly; line-height:16px; color:#95a5a6; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">We let you now that you are stopping our newslatter service, thank you for subscribe with us.</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center">
                                                                                                <table align="center" cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td align="center" style="border:#2980b9 solid 1px; border-radius:4px; color:#16a085; display:block; font-family: Open Sans, sans-serif; font-size:12px; font-weight:bold; mso-line-height-rule:exactly; line-height:12px; text-align:center; text-decoration:none; padding-top: 10px; padding-bottom: 10px; width:117px; -webkit-text-size-adjust:none;"><a style="color:#2980b9;font-family: Open Sans, sans-serif; font-size:13px; font-weight:800;" href="#">Resubscribe</a></td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                                                </table>
                                                                                            </td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center"><table cellspacing="0" cellpadding="0" border="0">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td style="background-color:#2980b9; border:#2980b9 solid 1px; border-radius:4px; color:#ffffff; display:block; font-family: Open Sans, sans-serif; font-size:12px; font-weight:bold; line-height:12px; text-align:center; text-decoration:none; padding-top: 10px; padding-bottom: 10px; width:117px; -webkit-text-size-adjust:none;"><a style="color:#ffffff;" href="#">ASK US</a></td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            ...
                                                            <table width="100%" bgcolor="#2c3e50" cellspacing="0" cellpadding="0" border="0" class="full-width" >
                                                                <tbody>
                                                                    <tr>
                                                                        <td height="28" align="center" style="font-family: Open Sans, sans-serif;font-size:11px; font-weight:normal; color:#7f8c8d">copyright by e-newsletter </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                            <!-- End Space -->
...
$headers .= 'Cc: Verification E-Mail' . "\r\n"; 
