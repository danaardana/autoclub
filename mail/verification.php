                                                                            ...
                                                                            <tr>
                                                                                <td valign="top" align="center">
                                                                                    ...
                                                                                    <table width="357" align="left" cellspacing="0" cellpadding="0" border="0" class="full-width">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td align="left" style="font-size:15px; color:#2c3e50; font-weight:bold; font-family: Open Sans, sans-serif;">Why verify?</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td height="26" align="left"><img src="img/green_line.jpg" width="30" height="2" alt="" /></td>
                                                                                            </tr>
                                                                                            <tr >
                                                                                                <td style="font-size:13px;mso-line-height-rule:exactly; line-height:16px; color:#95a5a6; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">We use E-Mail and Phone number as our login credential and reminder if you have a schedule with us.<br /><br />Therefore we need to clarify an active e-mail and phone number to make sure its a correct owner</td>
                                                                                            </tr>
                                                                                            <tr>
