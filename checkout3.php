...
if (!isset($_SESSION['name'])){
    $_SESSION['history'] = "..\checkout3.php";
                        ...
                        <form action="/" method="post" class='s-submit'>
                            <div class="b-submit__main-plan wow zoomInUp" data-wow-delay="0.3s">
                                <header class="s-headerSubmit s-lineDownLeft">
                                    <h2>Order in prosses</h2>
                                </header>
                                <p>Tahnk for choosing us, we will send a receipt to your email</p>
                            </div>
                            <button type="submit" name="btnPay" class="btn m-btn pull-right wow zoomInUp" data-wow-delay="0.3s">Home<span class="fa fa-angle-right"></span></button>
                        </form>
                    </div>
                </div>
            </div>
