...
$query = "SELECT * FROM cars WHERE car_status_shop = 'AVAILABLE'";
$featured = mysqli_query($conn, $query);

$query = "SELECT * FROM cars WHERE car_status_shop = 'AVAILABLE' ORDER BY car_id DESC LIMIT 4";
$latest = mysqli_query($conn, $query);

$queryA = "SELECT DISTINCT car_maker FROM cars WHERE car_status_shop = 'AVAILABLE' ORDER BY car_maker";
$filterMaker= mysqli_query($conn, $queryA);
$queryB = "SELECT DISTINCT car_year FROM cars WHERE car_status_shop = 'AVAILABLE' ORDER BY car_year";
$filterYear= mysqli_query($conn, $queryB);
            ...
            <form action="backend\listings.php" method="POST" class="b-search__main">
                ...
                <div class="b-search__main-type wow zoomInUp" data-wow-delay="0.3s">
                    ...
                    <div class="col-xs-12 col-md-10">
                        <div class="row">
                            <div class="col-xs-2">
                                <input id="type1" type="radio" value="Pickup" name="body" />
                            ...
                            <div class="col-xs-2">
                                <input id="type2" type="radio" value="SUV" name="body" />
                            ...
                            <div class="col-xs-2">
                                <input id="type3" type="radio" value="Coupe" name="body" />
                            ...
                            <div class="col-xs-2">
                                <input id="type4" type="radio" value="Convertible" name="body" />
                            ...
                            <div class="col-xs-2">
                                <input id="type5" type="radio" value="Sedan" name="body" />
                            ...
                            <div class="col-xs-2">
                                <input id="type6" type="radio" value="Minicar" name="body" />
                        ...
                        <div class="col-xs-12 col-md-8">
                            <div class="m-firstSelects">
                                <div class="col-xs-4">
                                    ...
                                    <?php while($showMaker = mysqli_fetch_array($filterMaker)) {?>
                                        <option value="<?php echo $showMaker['car_maker']; ?>"><?php echo $showMaker['car_maker']; ?></option>                   
                                    <?php } ?>
                                    </select>
                                ...
                                <div class="col-xs-4">
                                    <select name="status">
                                        <option value="All" selected="">Vehicle Status</option>
                                ...
                                <div class="col-xs-4">
                                    ...
                                    <?php while($showYear = mysqli_fetch_array($filterYear)) {?>
                                        <option value="<?php echo $showYear['car_year']; ?>"><?php echo $showYear['car_year']; ?></option>                   
                                    <?php } ?>
                                    </select>
                                    <span class="fa fa-caret-down"></span>
                                </div>
        ...
        <div class="container">
            ...
            <div id="carousel-small" class="owl-carousel enable-owl-carousel" data-items="4" data-navigation="true" data-auto-play="true" data-stop-on-hover="true" data-items-desktop="4" data-items-desktop-small="4" data-items-tablet="3" data-items-tablet-small="2">
                ...
                <?php if (mysqli_num_rows($featured) > 0) {
                  while($cars = mysqli_fetch_assoc($featured)) {
                 ?>
                <div>
                    <div class="b-featured__item wow rotateIn" data-wow-delay="0.3s">
                        <a href="detail.php?id=<?php echo $cars['car_id']; ?>">
                            <img src=" <?php echo $cars['car_thumbnail']; ?>" style="width:270px;height:240px;" alt="mers" />
                        ...
                        <h5><a href="detail.php?id=<?php echo $cars['car_id'];?>">
                            <?php 
                            echo $cars['car_maker']; 
                            echo ' ';
                            echo $cars['car_model'];
                            ...
                            echo $cars['car_year'];
                            ?>      </a></h5>
                        <div class="b-featured__item-count"><span class="fa fa-tachometer"></span><?php echo $cars['car_kilomatres']; ?> KM</div>
                ...
                <div class="col-xs-6">
                    <div class="b-homeAuto__latest">
                        ...
                        <div class="b-auto__main">
                            <div class="row">                                
                            <?php 
                            while($sale = mysqli_fetch_assoc($latest)) {
                             ?>
                                <div class="col-md-6 col-sm-12">
                                    <div class="b-auto__main-item wow zoomInUp" data-wow-delay="0.3s">
                                        <img class="img-responsive center-block" src="<?php echo $sale['car_thumbnail']; ?>" style="width:170px;height:120px;" alt="nissan" />
                                        <div class="b-world__item-val">
                                            <span class="b-world__item-val-title">REGISTERED <span>2014</span></span>
                                        </div>
                                        <h2><a href="detail.php?id=<?php echo $sale['car_id']; ?>">
                                            <?php 
                                            echo $sale['car_maker']; 
                                            echo ' ';
                                            echo $sale['car_model'];
                                        ...
                                        <div class="b-auto__main-item-info">
                                            <span class="m-price">Rp 
                                                <?php 
                                                echo $sale['car_price'];
                                                echo ' '; 
                                                echo $sale['car_pricetext']; ?>
                                            </span>
                                            <span class="m-number">
                                                <span class="fa fa-tachometer"></span><?php echo $sale['car_kilomatres']; ?> KM
                                            </span>
                                        </div>
                                        <div class="b-featured__item-links m-auto">
                                        <a href="#">Registered <?php echo $sale['car_year']; ?></a>
                                        <a href="#"><?php echo $sale['car_drivetrain']; ?></a>
                                        <a href="#"><?php echo $sale['car_passangers']; ?> Passangers</a>
                                        <a href="#"><?php echo $sale['car_fuel']; ?></a>
                                        </div>
                                    </div>
                                </div>
                            <?php } ?>
                        ...
                        <div class="b-homeAuto__world-item wow zoomInUp" data-wow-delay="0.3s">
                            <div class="row">
                                <div class="col-xs-12 col-sm-7">
                                    <div class="b-homeAuto__world-item-info">
                                        <h3>
                                            2015 Chevrolet Corvette Z06 vs.
            ...
            <div class="row wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
                ...
                <div class="col-xs-8">
                    <div class="b-contact__form">
                        ...
                        <form action="backend\subscribe_.php" method="POST">
                            <div><span class="fa fa-user"></span><input type="text" name="subs-name" required placeholder="Your Name" /></div>
                            <div><span class="fa fa-envelope"></span><input type="text" name="subs-email" required placeholder="Your Email" /></div>
