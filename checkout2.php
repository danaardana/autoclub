...
if (!isset($_SESSION['name'])){
    $_SESSION['history'] = "..\checkout2.php";
...
if (isset($_POST['btnPay'])){
    ...
    $query3 = "UPDATE shopping SET shop_status WHERE shop_cus = $userId AND shop_car = $carId";
    $query4 = "UPDATE shopping SET car_status_shop='$statusShop' WHERE car_id = $carId";
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-6">
                    <div class="b-submit__main">
                        <form action="checkout3.php" method="post" class='s-submit'>
                            <div class="b-submit__main-plan wow zoomInUp" data-wow-delay="0.3s">
                                <header class="s-headerSubmit s-lineDownLeft">
                                    <h2>Checkout <span class="b-submit__main-plan-money">( <span class="b-submit__main-plan-money-num">Rp <?php 
                                            echo $car['car_price'];
                                            echo ' '; 
                                            echo $car['car_pricetext']; ?></span>)</span></h2>
                                </header>
                                ...
                                <div class="b-submit__main-contacts-check">
                                    <input type="radio" name="check2" id="check1" checked="checked" />
                                    ...
                                    <input type="radio" name="check2" id="check3" />
                                    <label class="s-submitCheckLabel" for="check3"><span class="m-circle"></span></label>
                                    <label class="s-submitCheck" for="check2">DEBIT</label>
                                    <input type="radio" name="check2" id="check4" />
                                    <label class="s-submitCheckLabel" for="check4"><span class="m-circle"></span></label>
                                    <label class="s-submitCheck" for="check2">QRIS</label>
                                </div>
                                <div class="b-submit__main-element">
                                    ...
                                    <div class="row m-smallPadding">
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <a href="#" class="btn m-btn m-pay">PAY<span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
